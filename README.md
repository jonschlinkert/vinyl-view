...
Extends vinyl-view with render and compile methods, and properties used for rendering.
...
Pull requests and stars are always welcome. For bugs and feature requests, [please create an issue](https://github.com/jonschlinkert/vinyl-view/issues/new).
